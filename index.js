...
function message(message){
    ...
    const motivation = ["un gagneur ne lâche","un homme prudent voit le mal de loin et s'est cache","la sagesse n'a pas d'âge","un homme patient monge le fruit mur","l'humilité precede la gloire","reste toi","bat toi pour ce que tu aime"];
